...
ak=r"x1kbYRksKTuBGRa0EXGgIB55cL6WqNSL"
#ak=r"5UK6Um2nRBqID8cTTgYblTbGQREW8DtC"

#input the coordinates
left_bottom = [121.480835,31.225715] #Should be in Baidu coordinate system
right_top = [121.487555,31.233033] #Should be in Baidu coordinate system

#input your filepath
filepath=r"C:\Users\Xin-yi.Song\Desktop\百度API\hk\\" #设置存放路径,最后需要两个斜杠，其中一个是转义符
    ...
    if len(road_traffic)==0:
        ...
        for element in road_traffic:
            ...
            if len(element)==1:#只返回路名，不包含拥堵情况
                ...
                section_desc=congestion['section_desc']#'拥堵路段'
                status=congestion['status']#'路段拥堵评价'
                congestion_trend=congestion['congestion_trend']#'较十分钟前拥堵趋势'
                congestion_distance=congestion['congestion_distance']#'拥堵距离'
                speed=congestion['speed']#'平均通行速度'
